...
(function() {
  ...
  compact = __webpack_require__(189);

  defaults = __webpack_require__(190);

  find = __webpack_require__(191);

  first = __webpack_require__(248);
  ...
  sortBy = __webpack_require__(255);

  take = __webpack_require__(261);

  utils.at = at = __webpack_require__(263);

  utils.clone = clone = __webpack_require__(121);

  utils.extend = extend = __webpack_require__(89);

  utils.filter = filter = __webpack_require__(284);

  utils.includes = includes = __webpack_require__(286);

  utils.isArray = isArray = __webpack_require__(0);

  utils.isEmpty = isEmpty = __webpack_require__(292);

  utils.isNumber = isNumber = __webpack_require__(293);

  utils.isObject = isObject = __webpack_require__(1);

  utils.isString = isString = __webpack_require__(67);

  utils.isUndefined = isUndefined = __webpack_require__(98);

  utils.keys = keys = __webpack_require__(7);

  utils.merge = merge = __webpack_require__(294);

  generate_token = __webpack_require__(299);
...
(function() {
  ...
  isUndefined = __webpack_require__(98);
  ...
  module.exports = function(new_config, new_value) {
    ...
    if ((cloudinary_config == null) || new_config === true) {
      ...
      if (cloudinary_url != null) {
        uri = __webpack_require__(39).parse(cloudinary_url, true);
        cloudinary_config = {
          cloud_name: uri.host,
...
var _ = __webpack_require__(171),  cloudinary = module.exports;
exports.config = __webpack_require__(17);
exports.utils = __webpack_require__(11);
exports.uploader = __webpack_require__(129);
exports.api = __webpack_require__(134);
exports.PreloadedFile = __webpack_require__(303);
...
exports.v2 = __webpack_require__(304);
...
(function() {
  ...
  UploadStream = __webpack_require__(301);
  ...
  post = function(url, post_data, boundary, file, callback, options) {
    ...
    post_options = __webpack_require__(39).parse(url);
    headers = {
...
(function() {
  ...
  call_api = function(method, uri, params, callback, options) {
    ...
    request_options = __webpack_require__(39).parse(api_url);
...
var cloudinary = __webpack_require__(88);
cloudinary.config({
...
console.log(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_typeof___default()(process.env.cloud_name), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_typeof___default()(process.env.api_key), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_typeof___default()(process.env.api_secret));
        ...
        if (event.body) {
            ...
            if (!body.password || !body.workId || body.password !== process.env.upload_password) {
                ...
                callback(null, {
                    statusCode: 200,
                    headers: headers,
                    body: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(payload)
                });
            }
...
"use strict";
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/billy/vue/new-models-dapp/node_modules/dotenv/lib/main.js'");
...
var baseFlatten = __webpack_require__(120),
    baseOrderBy = __webpack_require__(257),
...
var baseAt = __webpack_require__(264),
...
var arrayFilter = __webpack_require__(106),
    baseFilter = __webpack_require__(285),
    baseIteratee = __webpack_require__(26),
    isArray = __webpack_require__(0);
...
var Stack = __webpack_require__(40),
    ...
    isObject = __webpack_require__(1),
    keysIn = __webpack_require__(21),
    safeGet = __webpack_require__(128);
...
var assignMergeValue = __webpack_require__(127),
    ...
    isArguments = __webpack_require__(24),
    isArray = __webpack_require__(0),
    isArrayLikeObject = __webpack_require__(297),
    isBuffer = __webpack_require__(25),
    isFunction = __webpack_require__(35),
    isObject = __webpack_require__(1),
    isPlainObject = __webpack_require__(116),
...
(function() {
  ...
  stream = __webpack_require__(132);

  util = __webpack_require__(302);
...
(function() {
  ...
  v1 = __webpack_require__(88);

  clone = __webpack_require__(121);

  v2 = clone(v1);

  v2.api = __webpack_require__(135);

  v2.uploader = __webpack_require__(305);

  v2.search = __webpack_require__(306);
...
(function() {
  ...
  uploader = __webpack_require__(129);
...
(function() {
  ...
  ref = __webpack_require__(11), isEmpty = ref.isEmpty, isNumber = ref.isNumber;
